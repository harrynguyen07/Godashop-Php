            ...
            <aside class="col-md-6 cart-checkout">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-7">
                        ...
                        <br>
                        <span><?= $item['qty'] ?></span> x <span><?= number_format($item['unit_price']) ?> đ</span>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6 text-right">
                        <span class="payment-total"
                            data="<?= $cart->getTotalPrice() ?>"><?= number_format($cart->getTotalPrice() + $shipping_fee) ?>đ</span>
                    </div>
                </div>
            </aside>
            <div class="ship-checkout col-md-6">
                ...
                <form action="/index.php?c=payment&a=order" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="bank-info">STK: 1690059676<br>Chủ TK: Nguyễn Nam Hải. Ngân hàng: BIDV
                            TP.HCM <br>
