                                ...
                                <div role="tabpanel" class="tab-pane" id="product-comment">
                                    <form class="form-comment" action="" method="POST" role="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="" name="fullname" placeholder="Tên *" require ABSPATH_SITE . d>
                                            <input type="email" name="email" class="form-control" id="" placeholder="Email *" require ABSPATH_SITE . d>
                                            <textarea name="description" id="input" class="form-control" rows="3" require ABSPATH_SITE . d placeholder="Nội dung *"></textarea>
                                        </div>
                                    ...
                                    <div class="comment-list">
                                        <?php require ABSPATH_SITE .  'view/product/commentList.php' ?>
                                    </div>
