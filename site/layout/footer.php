                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-4 list">
                        <div class="footerLink">
                            ...
                            <ul class="list-unstyled">
                                <li>Phone: 0865.380.608</li>
                                <li><a href="mailto:harrynguyenqt74@gmail.com">Mail:
                                        harrynguyenqt74@gmail.com</a></li>
                            </ul>
                            <ul class="list-inline">
                                <li><a href="https://www.facebook.com/NamHai007"><i class="fab fa-facebook-f"></i></a>
                                </li>
...
<div class="modal fade" id="modal-login" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="/index.php?c=auth&a=login" method="POST" role="form">
                <div class="modal-body">
                    <div class="form-group">
