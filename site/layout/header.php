...
<?php global $routeName, $router, $slugify, $c, $a; ?>
...
<body>
    <header>
        ...
        <div class="top-navbar container-fluid">
            <div class="menu-mb">
                ...
                <a class="<?= in_array($routeName, ['product', 'productDetail']) ? 'active' : '' ?>" href="<?= $router->generate('product') ?>">Sản
                    phẩm</a>
            ...
            <div class="row">
                ...
                <div class="col-md-6 hidden-sm hidden-xs">
                    <ul class="list-inline">
                        <li><a href="https://www.facebook.com/NamHai007"><i class="fab fa-facebook-f"></i></a></li>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 hotline-search">
                    <div>
                        <p class="hotline-phone"><span><strong>Hotline: </strong><a href="tel:0865.380.608">0865.380.608</a></span></p>
                        <p class="hotline-email"><span><strong>Email: </strong><a href="mailto:harrynguyenqt74@gmail.com">harrynguyenqt74@gmail.com</a></span>
                        </p>
                    </div>
                    <form class="header-form" action="<?= $router->generate('search') ?>">
                        <div class="input-group">
                            <input type="search" class="form-control search" placeholder="Nhập từ khóa tìm kiếm" name="search" autocomplete="off" value="<?= $seach ?? '' ?>">
    ...
    <nav class="navbar navbar-default desktop-menu">
        <div class="container">
            <ul class="nav navbar-nav navbar-left hidden-sm hidden-xs">
                ...
                <li class="<?= in_array($routeName, ['product', 'productDetail']) ? 'active' : '' ?>"><a href="<?= $router->generate('product') ?>">Sản phẩm </a></li>
                ...
                <li class="<?= $routeName == 'contact' ? 'active' : '' ?>"><a href="<?= $router->generate('contact') ?>">Liên
                        hệ</a></li>
            </ul>
            <span class=" hidden-lg hidden-md experience">Trải nghiệm cùng sản phẩm của Goda</span>
            <ul class="nav navbar-nav navbar-right">
                <li class="cart"><a href="javascript:void(0)" class="btn-cart-detail" title="Giỏ Hàng"><i class="fa fa-shopping-cart"></i> <span class="number-total-product"></span></a>
                </li>
            </ul>
        </div>
    </nav>
    ...
    if ($message) :
    ?>
        <div class="text-center alert <?= $class ?> mt-3"><?= $message ?></div>
    <?php endif ?>